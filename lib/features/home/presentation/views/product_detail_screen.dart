            ...
            return SingleChildScrollView(
              child: Column(
                ...
                children: [
                  if (widget.product.oldPrice != null && (widget.product.oldPrice! - widget.product.price) > 0)
                    Align(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(color: Colors.orange[500], borderRadius: BorderRadius.circular(10)),
                        child: Text(
                          "Saving\n €${(widget.product.oldPrice! - widget.product.price).toStringAsFixed(2)}",
                          style: TextStyles.textViewRegular10.copyWith(color: Colors.white),
                        ),
                      ),
                    ),
                  10.ph,
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            ...
                            style:
                                TextStylesPaytoneOne.textViewRegular24.copyWith(color: Color(0xffEA4B48), fontSize: 13),
                          ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          "${widget.product.unit}",
                          style: TextStylesInter.textViewMedium15.copyWith(color: primaryGreen),
                        ),
                      )
                    ],
                  ),
                  ...
                  Text(
                    "Where to buy ?".tr(),
                    style: TextStylesInter.textViewMedium14.copyWith(color: Color(0xff123013)),
                  ),
                  FutureBuilder(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Column(children: [
                                      Text(
                                        " View all the available prices, add to your list, and streamline your shopping experience"
                                            .tr(),
                                      ...
                                      GestureDetector(
                                        onTap: () async {
                                          if (FirebaseAuth.instance.currentUser != null &&
                                              SubscriptionProvider.get(context).isSubscribed) {

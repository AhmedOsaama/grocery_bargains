...
class _CustomizeExperienceScreenState extends State<CustomizeExperienceScreen> {
  ...
  bool isTextEmpty = (_goalsController.text.trim().isEmpty || _favouriteController.text.trim().isEmpty || _biggestFrustrationsController.text.trim().isEmpty);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text('Lets Customise Your Experience'.tr(), style: TextStylesInter.textViewBold26,textAlign: TextAlign.center,),
                  15.ph,
                  Text('Tell us about your grocery shopping habits and goals to help us tailor the app to your specific needs.'.tr(), style: TextStylesInter.textViewLight15,textAlign: TextAlign.center,),
                  20.ph,
                  Text("What are your top grocery shopping goals?".tr(), style: TextStyles.textViewRegular15,),
                  10.ph,
                  GenericField(
                  ...
                  20.ph,
                  Text("What are your favorite stores to shop at?".tr(), style: TextStyles.textViewRegular15,),
                  10.ph,
                  GenericField(
                  ...
                  20.ph,
                  Text("What are your biggest frustrations with grocery shopping?".tr(), style: TextStyles.textViewRegular15,),
                  10.ph,
                  GenericField(
    ...
    return isTextEmpty ? null : (){
          ...
          if(isValid!) {
            ...
            var contactData = {
              ...
              'favorite_grocery': _favouriteController.text.trim(),

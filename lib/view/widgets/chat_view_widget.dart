          ...
          children: [
            ...
            if (!tutorialProvider.isTutorialRunning)
              StreamBuilder<QuerySnapshot>(
                  ...
                  return Column(
                    children: [
                      ChatlistOverviewWidget(items: items, isFirstTimeChatlist: isFirstTimeChatlist,),
                      Expanded(
                        child: PageView(
                              children: [
                                StreamBuilder<QuerySnapshot>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      if (messages.isEmpty || !snapshot.hasData) {
                                        return AddFriendsWidget(showInviteDialog: widget.showInviteMembersDialog,);
                                      }
                                      return Column(
                                        children: [
                                          Expanded(
                                            ...
                                            children: [
                                                Builder(builder: (ctx) {
                                                  ...
                                                  if (isFirstTimeChatlist && items.isNotEmpty) {
                                                    ...
                                                    if (albertItems.isEmpty &&
                                                        jumboItems.isEmpty &&
                                                        hoogvlietItems.isEmpty &&
                                                        dirkItems.isEmpty)
                                                  ...
                                                  if (!isFirstTimeChatlist &&
                                                      items.isEmpty) //not first time case and items are empty
                                                    return Column(

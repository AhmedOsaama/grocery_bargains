...
class _CategoryItemsScreenState extends State<CategoryItemsScreen> {
  ...
  var allItems = [
    ...
    Item(
      ...
      id: "3",
      imageUrl:
          'https://images.heb.com/is/image/HEBGrocery/000374791?fit=constrain,1&wid=800&hei=800&fmt=jpg&qlt=85,0&resMode=sharp2&op_usm=1.75,0.3,2,0',
      categoryId: "",
      createdAt: "",
      createdBy: "",
    ),
    Item(
      ...
      id: "4",
      imageUrl:
          'https://5.imimg.com/data5/IE/YN/MY-51545753/sg-cauliflower-2c-1nos-500x500.png',
      categoryId: "",
      createdAt: "",
      createdBy: "",
    ),
      ...
      body: Column(
        children: [
          ...
          DragTarget<Item>(
            builder: (context, candidItems, _) {
              return Container(
                ...
                height: 101.h,
                color: candidItems.isNotEmpty
                    ? Colors.red.withOpacity(0.5)
                    : Color.fromRGBO(77, 191, 163, 1),
                child: Center(
                    child: Text(
          ...
          Expanded(
            ...
            children: allItems
                .map((item) => LongPressDraggable<Item>(
                      data: item,
                      ...
                      feedback: Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                              image: NetworkImage(item.imageUrl), opacity: 0.8),
                          borderRadius: BorderRadius.circular(6),

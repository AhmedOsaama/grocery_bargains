...
class NetworkServices {
  ...
  static Future<http.Response> searchComparisonByAlbertLink(
  ...
  static Future<http.Response> searchComparisonByJumboLink(
      String searchTerm) async {
    final url = Uri.parse(
  ...
  static Future<http.Response> searchComparisonByHoogvlietLink(
      String searchTerm) async {
    final url = Uri.parse(
  ...
  static Future<http.Response> searchHoogvlietProducts(
      String searchTerm) async {
    final url = Uri.parse(
  ...
  static Future<http.Response> searchAlbertProductByLink(
      String searchTerm) async {
    final url = Uri.parse(
  ...
  static Future<http.Response> searchJumboProductByLink(
      String searchTerm) async {
    final url = Uri.parse(
  ...
  static Future<http.Response> searchHoogvlietProductByLink(
      String searchTerm) async {
    final url = Uri.parse(
  ...
  //by name
  static Future<http.Response> searchAlbertProductByName(
      String searchTerm) async {
    final url = Uri.parse(
  ...
  static Future<http.Response> searchJumboProductByName(
      String searchTerm) async {
    final url = Uri.parse(
  ...
  static Future<http.Response> searchHoogvlietProductByName(
      String searchTerm) async {
    final url = Uri.parse(
